...
config. BgColor 		= '#373f56' // Background colour (HTML colour value, in quotes)
config. BgImg			= ''		// Path to background image, none if empty string ''
config. BorderColor		= '#373f56'
...
config. CloseBtnColors	= ['#d44c6a', '#fff', '#d44c6a', '#fff']	  // [Background, text, hovered background, hovered text] - use empty strings '' to inherit title colours
...
config. FontFace		= 'Arial,Roboto'
config. FontSize		= '.9rem' 	// E.g. '9pt' or '12px' - unit is mandatory
...
config. OffsetY			= -80 		// Vertical offset
config. Opacity			= 10		// Integer between 0 and 100 - opacity of tooltip in percent
